...
>-------------------------------------------------------------
* **===== ===== GNU-Linux ===== =====**
    - **Nebra Mathieu**. *Reprenez le contrôle à l'aide de Linux !*. OpenClassrooms. [[Lien direct](https://openclassrooms.com/courses/reprenez-le-controle-a-l-aide-de-linux)] {Cours débutant sur Linux}
    **DaveChild**. *Linux Command Line Cheat Sheet*. [[Lien direct](https://www.cheatography.com/davechild/cheat-sheets/linux-command-line/)].{Aide Mémoire des lignes de commandes TERMINAL Linux}

* **===== ===== Versionning ===== =====**
    - **Stansberry Glen**. *6 Version Control Systems Reviewed*. Smashingmagazine. [[Lien direct](https://www.smashingmagazine.com/2008/09/the-top-7-open-source-version-control-systems/)].{Article en anglais sur les différents logiciels de versionning}
    - **Nebra Mathieu**. *Gérez vos codes source avec Git*. OpenClassrooms. [[Lien direct](https://openclassrooms.com/courses/gerez-vos-codes-source-avec-git)] {Cours débutant sur Git}
    - **Gauthier Marc G.**. *Gérez votre code avec Git et GitHub*. OpenClassrooms. [[Lien direct](https://openclassrooms.com/courses/gerer-son-code-avec-git-et-github)] {Cours débutant sur Git et GitHub}
    - **Olywei**. *Visualizing Git Concepts with D3*. [[Lien direct](http://onlywei.github.io/explain-git-with-d3/)]. {Tutoriel pour Gir. Il y a un repos GitHub pour ce site-web/projet}
    - **Dudler Roger**. *Git Petit Guide*. [[Lien direct](http://rogerdudler.github.io/git-guide/index.fr.html)].{Tuto Git trop choupinou}
    - **Xtof**. *GitHub Pour les Nuls : Pas de Panique, Lancez-Vous ! (Première Partie)*. [[Lien direct](https://www.christopheducamp.com/2013/12/15/github-pour-nuls-partie-1/)].{Tutoriel GitHub débutant}
    - **GIT-Tower**. *Git Cheat Sheet*. [[Lien direct](https://www.git-tower.com/blog/git-cheat-sheet/].{Aide Mémoire des lignes de commandes GIT}
    - **GitHub Team**. *Connecting to GitHub with SSH*. [[Lien direct](https://help.github.com/articles/connecting-to-github-with-ssh/)].{Comment Sécuriser sa connetion à GitHub via l'ajout de clef e cryptographie SSH}
    - **Vandamme Marc**. *Gérez vos projets à l'aide du gestionnaire de versions Subversion*. OpenClassrooms. [[Lien direct](https://openclassrooms.com/courses/gerez-vos-projets-a-l-aide-du-gestionnaire-de-versions-subversion)] {Cours débutant sur Subversion}
    - **Meianki**. *Gérer vos projets avec Mercurial*. OpenClassrooms. [[Lien direct](https://openclassrooms.com/courses/gerer-vos-projets-avec-mercurial)] {Cours débutant sur Mercurial}
* **===== ===== Editeurs de texte et IDE ===== =====**
    - **Bousendorfer Matthieu**. *Atom, les extensions !*. Blog Edenpulse. [[Lien direct](https://blog.edenpulse.com/atom-les-extensions/)] {Pour savoir quels sont les meilleurs extensions pour aller avec l'éditeur de texte ATOM}
    - **Tobal**. *10 plugins Sublime Text indispensables*. Le Blog de Tobal. [[Lien direct](http://tobal.fr/10-plugins-sublime-text-indispensables/)].{Pour savoir quels sont les meilleurs extensions pour aller avec l'éditeur de texte SublimeText}
* **===== ===== Pré-Processeur HTML ===== =====**
